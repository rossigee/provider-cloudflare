...
func setupRBAC(c client.Client, l logging.Logger) error {
	...
	rules := []rbacv1.PolicyRule{
		...
		{APIGroups: []string{"cloudflare.m.crossplane.io"}, Resources: []string{"providerconfigs", "providerconfigs/status", "providerconfigusages", "providerconfigusages/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"device.cloudflare.m.crossplane.io"}, Resources: []string{"deviceposturerules", "deviceposturerules/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"dns.cloudflare.m.crossplane.io"}, Resources: []string{"records", "records/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"emailrouting.cloudflare.m.crossplane.io"}, Resources: []string{"rules", "rules/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"firewall.cloudflare.m.crossplane.io"}, Resources: []string{"filters", "filters/status", "rules", "rules/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"loadbalancing.cloudflare.m.crossplane.io"}, Resources: []string{"loadbalancermonitors", "loadbalancermonitors/status", "loadbalancerpools", "loadbalancerpools/status", "loadbalancers", "loadbalancers/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"logpush.cloudflare.m.crossplane.io"}, Resources: []string{"jobs", "jobs/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		...
		{APIGroups: []string{"rulesets.cloudflare.m.crossplane.io"}, Resources: []string{"rulesets", "rulesets/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		...
		{APIGroups: []string{"sslsaas.cloudflare.m.crossplane.io"}, Resources: []string{"customhostnames", "customhostnames/status", "fallbackorigins", "fallbackorigins/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"transform.cloudflare.m.crossplane.io"}, Resources: []string{"rules", "rules/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
